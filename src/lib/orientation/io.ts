...
import { ACC_CALIBRATION_MS, decodeBoardAlignment, encodeBoardAlignment, type BoardAlignment } from './model'
 ...
 */
export async function calibrateAccelerometer(client: MspClient, waitMs = ACC_CALIBRATION_MS): Promise<void> {
