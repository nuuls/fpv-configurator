...
| Bidirectional DShot | switch | `dshot_bidir` · `MSP_MOTOR_CONFIG` (131/222) | off | Only with a DShot protocol |
| Motor poles | number | `motor_poles` | even, 4–40 · 14 | |
| Prop direction | select | `yaw_motors_reversed` · `MSP_MIXER_CONFIG` (42/43) | Props in, Props out | |
