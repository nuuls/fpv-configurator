...
Two sliders and one stick-feel choice. The firmware's own slider math ("simplified tuning") computes the PIDs.
...
Pinned on every save: `simplified_pids_mode = RPY`, I / PI / pitch-PI / roll-pitch-ratio sliders = 1.0,
...
- [x] Two sliders; PID table follows them; hidden-tuning warning shown
...
- [ ] After saving, Configurator shows Dynamic D slider at 0 and the others at 1.0
