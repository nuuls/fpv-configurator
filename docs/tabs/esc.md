...
| Minimum startup power            [ 1025 ] |   <- what can be changed
...
| Minimum startup power            [ 1025 ] | | Essentials …              |
| …                                         | | …                         |
+-------------------------------------------+ +---------------------------+
                                            [Revert] [Save]
```
...
| Version check                  | error notice + "Version not supported" on the card              | Bluejay: `main.sub` of the settings block must be 0.21. AM32: `major.minor` must be 2.21                                                                                                                                                     | —                                               | Older Bluejay: told to update with ESC Configurator; other AM32: told to flash 2.21 with the AM32 configurator. No settings are shown or changed on such an ESC                                                                                    |
| Bluejay: minimum startup power | number                                                          | byte 0x04; shown as 1000 + raw × 1000 / 2047                                                                                                                                                                                                 | 1000–1125, step 5 · 1010                        | Same for all Bluejay ESCs                                                                                                                                                                                                                          |
| Bluejay: maximum startup power | number                                                          | byte 0x07; shown as 1000 + raw × 4                                                                                                                                                                                                           | 1004–1300, step 4 · 1020                        | Same for all Bluejay ESCs                                                                                                                                                                                                                          |
